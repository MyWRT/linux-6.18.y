...
static u32 bbr_tso_segs_goal(struct sock *sk)
{
	...
	min_segs = bbr_min_tso_segs(sk);

	return min(bbr_tso_autosize(sk, tp->mss_cache, min_segs), 0x7FU);
}
...
MODULE_DESCRIPTION("TCP BBR Plus, enhanced version of BBR (Bottleneck Bandwidth and RTT)");
